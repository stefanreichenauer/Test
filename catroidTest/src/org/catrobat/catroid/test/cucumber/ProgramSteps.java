...
public class ProgramSteps extends AndroidTestCase {
	...
	public void I_have_a_program() throws IOException {
		...
		//UiTestUtils.createBroadcastProject();
	...
	public void object_has_start_script(String object) {
		...
		Script scriptToStartWith = null;

		if (sprite.getScriptList() != null && !sprite.getScriptList().isEmpty()){
			List<Script> scriptList = sprite.getScriptList();
			scriptToStartWith= scriptList.get(0);
		}
	...
	public void var_should_greater_than_equal_float(String name, float expected) {
		...
		float actual = (float)variable.getValue();
